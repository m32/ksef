...
T = TypeVar("T", bound="VisibilityInvoiceResponseStatusMain")


@_attrs_define
class VisibilityInvoiceResponseStatusMain:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        visibility_invoice_response_status_main = cls(
        ...
        visibility_invoice_response_status_main.additional_properties = d
        return visibility_invoice_response_status_main
