...
T = TypeVar("T", bound="ScamInvoiceResponse")


@_attrs_define
class ScamInvoiceResponse:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        scam_invoice_response.additional_properties = d
        return scam_invoice_response
