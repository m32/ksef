...
T = TypeVar("T", bound="RevokeContextCredentialsRequestType")


@_attrs_define
class RevokeContextCredentialsRequestType:
    """ 
        Attributes:
            ...
            credentials_role (CredentialsRoleRequestContextBaseType):
     """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        credentials_role = CredentialsRoleRequestContextBaseType.from_dict(d.pop("credentialsRole"))




        revoke_context_credentials_request_type = cls(
            context_identifier=context_identifier,
            credentials_identifier=credentials_identifier,
            credentials_role=credentials_role,
        )

        revoke_context_credentials_request_type.additional_properties = d
        return revoke_context_credentials_request_type
