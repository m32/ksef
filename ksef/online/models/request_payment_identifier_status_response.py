...
T = TypeVar("T", bound="RequestPaymentIdentifierStatusResponse")


@_attrs_define
class RequestPaymentIdentifierStatusResponse:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        request_payment_identifier_status_response = cls(
        ...
        request_payment_identifier_status_response.additional_properties = d
        return request_payment_identifier_status_response
