...
T = TypeVar("T", bound="VisibilityInvoiceStatusResponse")


@_attrs_define
class VisibilityInvoiceStatusResponse:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        visibility_invoice_status_response = cls(
        ...
        visibility_invoice_status_response.additional_properties = d
        return visibility_invoice_status_response
