...
if TYPE_CHECKING:
  ...
  from ..models.credentials_role_request_standard_base_type import CredentialsRoleRequestStandardBaseType





T = TypeVar("T", bound="RevokeCredentialsRequestType")


@_attrs_define
class RevokeCredentialsRequestType:
    """ 
        Attributes:
            credentials_identifier (CredentialsIdentifierRequestType):
            credentials_role_list (List['CredentialsRoleRequestStandardBaseType']):
     """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for credentials_role_list_item_data in (_credentials_role_list):
            credentials_role_list_item = CredentialsRoleRequestStandardBaseType.from_dict(credentials_role_list_item_data)
        ...
        revoke_credentials_request_type = cls(
            credentials_identifier=credentials_identifier,
            credentials_role_list=credentials_role_list,
        )

        revoke_credentials_request_type.additional_properties = d
        return revoke_credentials_request_type
