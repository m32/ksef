...
T = TypeVar("T", bound="KsefReferenceNumberListResponseObject")


@_attrs_define
class KsefReferenceNumberListResponseObject:
    """ 
        Attributes:
            is_subject (float):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ksef_reference_number_list_response_object = cls(
            is_subject=is_subject,
            ksef_reference_number=ksef_reference_number,
        )

        ksef_reference_number_list_response_object.additional_properties = d
        return ksef_reference_number_list_response_object
