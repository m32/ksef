...
from ...models.grant_credentials_request import GrantCredentialsRequest
...
def _get_kwargs(
    *,
    json_body: GrantCredentialsRequest,
...
def sync_detailed(
    *,
    ...
    print("*"*20, "/online/Credentials/Grant")
    print(kwargs)
