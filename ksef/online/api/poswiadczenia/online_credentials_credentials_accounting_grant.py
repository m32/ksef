...
from ...models.grant_accounting_credentials_request import GrantAccountingCredentialsRequest



def _get_kwargs(
    *,
    json_body: GrantAccountingCredentialsRequest,
    ...
    return {
        "method": "post",
        "url": "/online/Credentials/AccountingGrant",
        "json": json_json_body,
    }
...
def sync_detailed(
    *,
    ...
    print("*"*20, "/online/Credentials/AccountingGrant")
    print(kwargs)
