...
from ...models.revoke_accounting_credentials_request import RevokeAccountingCredentialsRequest



def _get_kwargs(
    *,
    json_body: RevokeAccountingCredentialsRequest,
    ...
    return {
        "method": "post",
        "url": "/online/Credentials/AccountingRevoke",
        "json": json_json_body,
    }
...
def sync_detailed(
    *,
    ...
    print("*"*20, "/online/Credentials/AccountingRevoke")
    print(kwargs)
