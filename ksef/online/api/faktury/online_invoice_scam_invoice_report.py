...
from ...models.report_scam_invoice_request import ReportScamInvoiceRequest



def _get_kwargs(
    *,
    json_body: ReportScamInvoiceRequest,
    ...
    return {
        "method": "post",
        "url": "/online/Invoice/Scam/Report",
        "json": json_json_body,
    }
...
def sync_detailed(
    *,
    ...
    print("*"*20, "/online/Invoice/Scam/Report")
    print(kwargs)
