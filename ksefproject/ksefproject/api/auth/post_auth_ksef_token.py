...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[AuthenticationInitResponse, ExceptionResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[AuthenticationInitResponse, ExceptionResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[AuthenticationInitResponse, ExceptionResponse, TooManyRequestsResponse]]:
...
def sync(
    *,
...
) -> Optional[Union[AuthenticationInitResponse, ExceptionResponse, TooManyRequestsResponse]]:
    """ Uwierzytelnienie z wykorzystaniem tokena KSeF
    ...
    Returns:
        Union[AuthenticationInitResponse, ExceptionResponse, TooManyRequestsResponse]
     """
