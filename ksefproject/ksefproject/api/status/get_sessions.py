...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, SessionsQueryResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, SessionsQueryResponse, TooManyRequestsResponse]]:
    return Response(
...
def sync_detailed(
...
) -> Response[Union[Any, ExceptionResponse, SessionsQueryResponse, TooManyRequestsResponse]]:
    ...
    **Wymagane uprawnienia**:
    - `Introspection`/`EnforcementOperations` – pozwala pobrać wszystkie sesje w bieżącym kontekście
    uwierzytelnienia `(ContextIdentifier)`.
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, SessionsQueryResponse, TooManyRequestsResponse]]:
    """ Pobranie listy sesji
    ...
    **Wymagane uprawnienia**:
    ...
    Returns:
        Union[Any, ExceptionResponse, SessionsQueryResponse, TooManyRequestsResponse]
     """
