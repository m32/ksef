...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, EnrollCertificateResponse, ExceptionResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, EnrollCertificateResponse, ExceptionResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, EnrollCertificateResponse, ExceptionResponse, TooManyRequestsResponse]]:
...
def sync(
    *,
...
) -> Optional[Union[Any, EnrollCertificateResponse, ExceptionResponse, TooManyRequestsResponse]]:
    """ Wysyłka wniosku certyfikacyjnego
    ...
    Returns:
        Union[Any, EnrollCertificateResponse, ExceptionResponse, TooManyRequestsResponse]
     """
