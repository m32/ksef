...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QueryCertificatesResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QueryCertificatesResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QueryCertificatesResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QueryCertificatesResponse, TooManyRequestsResponse]]:
    """ Pobranie listy metadanych certyfikatów
    ...
    **Sortowanie:**
    ...
    Returns:
        Union[Any, ExceptionResponse, QueryCertificatesResponse, TooManyRequestsResponse]
     """
