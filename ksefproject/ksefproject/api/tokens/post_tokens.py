...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, GenerateTokenResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, GenerateTokenResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, GenerateTokenResponse, TooManyRequestsResponse]]:
...
def sync(
    *,
...
) -> Optional[Union[Any, ExceptionResponse, GenerateTokenResponse, TooManyRequestsResponse]]:
    """ Wygenerowanie nowego tokena
    ...
    Returns:
        Union[Any, ExceptionResponse, GenerateTokenResponse, TooManyRequestsResponse]
     """
