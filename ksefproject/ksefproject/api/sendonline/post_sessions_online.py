...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, OpenOnlineSessionResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, OpenOnlineSessionResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, OpenOnlineSessionResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, OpenOnlineSessionResponse, TooManyRequestsResponse]]:
    """ Otwarcie sesji interaktywnej
    ...
    **Wymagane uprawnienia**: `InvoiceWrite`, `PefInvoiceWrite`, `EnforcementOperations`.
    ...
    Returns:
        Union[Any, ExceptionResponse, OpenOnlineSessionResponse, TooManyRequestsResponse]
     """
