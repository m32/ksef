...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, OpenBatchSessionResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, OpenBatchSessionResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, OpenBatchSessionResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, OpenBatchSessionResponse, TooManyRequestsResponse]]:
    """ Otwarcie sesji wsadowej
    ...
    **Wymagane uprawnienia**: `InvoiceWrite`, `EnforcementOperations`.
    ...
    Returns:
        Union[Any, ExceptionResponse, OpenBatchSessionResponse, TooManyRequestsResponse]
     """
