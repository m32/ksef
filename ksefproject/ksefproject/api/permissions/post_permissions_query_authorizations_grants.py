...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/permissions/query/authorizations/grants",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QueryEntityAuthorizationPermissionsResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QueryEntityAuthorizationPermissionsResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QueryEntityAuthorizationPermissionsResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QueryEntityAuthorizationPermissionsResponse, TooManyRequestsResponse]]:
    """ Pobranie listy uprawnień podmiotowych do obsługi faktur
    ...
    **Wymagane uprawnienia**: `CredentialsManage`, `CredentialsRead`, `PefInvoiceWrite`.
    ...
    Returns:
        Union[Any, ExceptionResponse, QueryEntityAuthorizationPermissionsResponse, TooManyRequestsResponse]
     """
