...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/permissions/query/personal/grants",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QueryPersonalPermissionsResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QueryPersonalPermissionsResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QueryPersonalPermissionsResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QueryPersonalPermissionsResponse, TooManyRequestsResponse]]:
    """ Pobranie listy własnych uprawnień
    ...
    **Sortowanie:**
    ...
    Returns:
        Union[Any, ExceptionResponse, QueryPersonalPermissionsResponse, TooManyRequestsResponse]
     """
