...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/permissions/query/subunits/grants",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QuerySubunitPermissionsResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QuerySubunitPermissionsResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QuerySubunitPermissionsResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QuerySubunitPermissionsResponse, TooManyRequestsResponse]]:
    """ Pobranie listy uprawnień administratorów jednostek i podmiotów podrzędnych
    ...
    **Wymagane uprawnienia**: `CredentialsManage`, `CredentialsRead`, `SubunitManage`.
    ...
    Returns:
        Union[Any, ExceptionResponse, QuerySubunitPermissionsResponse, TooManyRequestsResponse]
     """
