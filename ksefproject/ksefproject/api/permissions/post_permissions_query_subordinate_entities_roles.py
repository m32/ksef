...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/permissions/query/subordinate-entities/roles",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QuerySubordinateEntityRolesResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QuerySubordinateEntityRolesResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QuerySubordinateEntityRolesResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QuerySubordinateEntityRolesResponse, TooManyRequestsResponse]]:
    """ Pobranie listy podmiotów podrzędnych
    ...
    **Wymagane uprawnienia**: `CredentialsManage`, `CredentialsRead`, `SubunitManage`.
    ...
    Returns:
        Union[Any, ExceptionResponse, QuerySubordinateEntityRolesResponse, TooManyRequestsResponse]
     """
