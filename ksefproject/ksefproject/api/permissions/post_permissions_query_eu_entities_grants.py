...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/permissions/query/eu-entities/grants",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QueryEuEntityPermissionsResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QueryEuEntityPermissionsResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QueryEuEntityPermissionsResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QueryEuEntityPermissionsResponse, TooManyRequestsResponse]]:
    """ Pobranie listy uprawnień administratorów lub reprezentantów podmiotów unijnych uprawnionych do
    samofakturowania
    ...
    **Wymagane uprawnienia**: `CredentialsManage`, `CredentialsRead`, `VatUeManage`.
    ...
    Returns:
        Union[Any, ExceptionResponse, QueryEuEntityPermissionsResponse, TooManyRequestsResponse]
     """
