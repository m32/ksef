...
from ...models.indirect_permissions_grant_request import IndirectPermissionsGrantRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/permissions/indirect/grants",
    }
...
def sync_detailed(
    *,
    ...
    /v2/permissions/entities/grants](/docs/v2/index.html#tag/Nadawanie-
    uprawnien/paths/~1permissions~1entities~1grants/post)).
