...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/permissions/query/entities/roles",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QueryEntityRolesResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QueryEntityRolesResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QueryEntityRolesResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QueryEntityRolesResponse, TooManyRequestsResponse]]:
    """ Pobranie listy ról podmiotu
    ...
    **Wymagane uprawnienia**: `CredentialsManage`, `CredentialsRead`.
    ...
    Returns:
        Union[Any, ExceptionResponse, QueryEntityRolesResponse, TooManyRequestsResponse]
     """
