...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/permissions/query/persons/grants",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QueryPersonPermissionsResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QueryPersonPermissionsResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QueryPersonPermissionsResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QueryPersonPermissionsResponse, TooManyRequestsResponse]]:
    """ Pobranie listy uprawnień do pracy w KSeF nadanych osobom fizycznym lub podmiotom
    ...
    **Wymagane uprawnienia**: `CredentialsManage`, `CredentialsRead`, `SubunitManage`.
    ...
    Returns:
        Union[Any, ExceptionResponse, QueryPersonPermissionsResponse, TooManyRequestsResponse]
     """
