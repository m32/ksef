...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, QueryInvoicesMetadataResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, QueryInvoicesMetadataResponse, TooManyRequestsResponse]]:
    return Response(
...
) -> Response[Union[Any, ExceptionResponse, QueryInvoicesMetadataResponse, TooManyRequestsResponse]]:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, QueryInvoicesMetadataResponse, TooManyRequestsResponse]]:
    """ Pobranie listy metadanych faktur
    ...
    **Wymagane uprawnienia**: `InvoiceRead`.
    ...
    Returns:
        Union[Any, ExceptionResponse, QueryInvoicesMetadataResponse, TooManyRequestsResponse]
     """
