...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, ExceptionResponse, ExportInvoicesResponse, TooManyRequestsResponse]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, ExceptionResponse, ExportInvoicesResponse, TooManyRequestsResponse]]:
    return Response(
...
def sync_detailed(
    *,
...
) -> Response[Union[Any, ExceptionResponse, ExportInvoicesResponse, TooManyRequestsResponse]]:
    ...
    i dodaje faktury(nazwa pliku: <b>{ksefNumber}.xml</b>) do paczki aż do osiągnięcia jednego z
    poniższych limitów:
...
def sync(
...
) -> Optional[Union[Any, ExceptionResponse, ExportInvoicesResponse, TooManyRequestsResponse]]:
    """ Eksport paczki faktur
    ...
    **Wymagane uprawnienia**: `InvoiceRead`.
    ...
    Returns:
        Union[Any, ExceptionResponse, ExportInvoicesResponse, TooManyRequestsResponse]
     """
