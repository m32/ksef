...
T = TypeVar("T", bound="BlockContextAuthenticationRequest")



@_attrs_define
class BlockContextAuthenticationRequest:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_context_authentication_request = cls(
            context_identifier=context_identifier,
        )

        return block_context_authentication_request
