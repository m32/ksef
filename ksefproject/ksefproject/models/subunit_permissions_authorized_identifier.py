...
T = TypeVar("T", bound="SubunitPermissionsAuthorizedIdentifier")



@_attrs_define
class SubunitPermissionsAuthorizedIdentifier:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subunit_permissions_authorized_identifier = cls(
            type_=type_,
            value=value,
        )

        return subunit_permissions_authorized_identifier
