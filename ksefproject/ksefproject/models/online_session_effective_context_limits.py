...
T = TypeVar("T", bound="OnlineSessionEffectiveContextLimits")



@_attrs_define
class OnlineSessionEffectiveContextLimits:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        online_session_effective_context_limits = cls(
        ...
        return online_session_effective_context_limits
