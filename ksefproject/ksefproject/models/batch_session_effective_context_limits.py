...
T = TypeVar("T", bound="BatchSessionEffectiveContextLimits")



@_attrs_define
class BatchSessionEffectiveContextLimits:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_session_effective_context_limits = cls(
        ...
        return batch_session_effective_context_limits
