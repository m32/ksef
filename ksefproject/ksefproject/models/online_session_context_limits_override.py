...
T = TypeVar("T", bound="OnlineSessionContextLimitsOverride")



@_attrs_define
class OnlineSessionContextLimitsOverride:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        online_session_context_limits_override = cls(
        ...
        return online_session_context_limits_override
