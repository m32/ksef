...
T = TypeVar("T", bound="InvoiceStatusInfoExtensionsType0")



@_attrs_define
class InvoiceStatusInfoExtensionsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        invoice_status_info_extensions_type_0 = cls(
        )
        ...
        invoice_status_info_extensions_type_0.additional_properties = additional_properties
        return invoice_status_info_extensions_type_0
