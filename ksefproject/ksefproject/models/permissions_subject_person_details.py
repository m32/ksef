...
from ..models.person_subject_details_type import PersonSubjectDetailsType
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="PermissionsSubjectPersonDetails")



@_attrs_define
class PermissionsSubjectPersonDetails:
    """ 
        Attributes:
            subject_details_type (PersonSubjectDetailsType): | Wartość | Opis |
                | --- | --- |
    ...
    subject_details_type: PersonSubjectDetailsType
    first_name: str
    last_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.person_identifier import PersonIdentifier
        d = dict(src_dict)
        subject_details_type = PersonSubjectDetailsType(d.pop("subjectDetailsType"))
        ...
        permissions_subject_person_details = cls(
        ...
        return permissions_subject_person_details
