...
T = TypeVar("T", bound="InvoiceMetadataBuyerIdentifier")



@_attrs_define
class InvoiceMetadataBuyerIdentifier:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoice_metadata_buyer_identifier = cls(
            type_=type_,
            value=value,
        )

        return invoice_metadata_buyer_identifier
