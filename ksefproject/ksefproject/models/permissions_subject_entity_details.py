...
from ..models.entity_subject_details_type import EntitySubjectDetailsType
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="PermissionsSubjectEntityDetails")



@_attrs_define
class PermissionsSubjectEntityDetails:
    """ 
        Attributes:
            subject_details_type (EntitySubjectDetailsType): | Wartość | Opis |
                | --- | --- |
    ...
    subject_details_type: EntitySubjectDetailsType
    full_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        subject_details_type = EntitySubjectDetailsType(d.pop("subjectDetailsType"))
        ...
        permissions_subject_entity_details = cls(
            subject_details_type=subject_details_type,
            full_name=full_name,
            address=address,
        )

        return permissions_subject_entity_details
